...
* **플래그를 선택하는 플래그를** 사용하면 (스팸, **[!UICONTROL User Flags]** 꺼짐, 모욕적 또는 반대), 안전 (모독, **[!UICONTROL System Flags]** 스팸 또는 마법과 같은 중재) 를 기준으로 필터링하거나 **[!UICONTROL Moderation Recommendations]**, 또는, ![](assets/appcontentfilter.png)
